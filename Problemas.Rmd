...
La tercera opción - emplear a un panadero con un contrato para todo el año y comprar los ingredientes - supone unos gastos mensuales adicionales de 8.000 euros.
Si a los clientes les gusta el pan, obtendrán un plus mensual de 20.000 euros. Si no, sólo obtendrá 2.000 euros de beneficio al mes con la ayuda que le preste el panadero en el negocio normal.

¿Qué le recomienda usted que opción eleja, si su objetivo es minimizar los costes?
